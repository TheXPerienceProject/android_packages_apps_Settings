...
import mx.xperience.framework.preference.SecureSettingListPreference;

import java.time.format.DateTimeFormatter;
import java.time.LocalTime;

@SearchIndexable
public class DcDimSettings extends DashboardFragment implements
        Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {

    private static final String TAG = "DcDimSettings";
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.dc_dim_settings);
}
