...
public class SettingsApplication extends Application {
    ...
    protected FixedArrayMap<String, PreferenceScreenMetadataFactory> preferenceScreenFactories() {
        ...
        FixedArrayMap<String, PreferenceScreenMetadataFactory> preferenceScreenFactories =
                PreferenceScreenCollector.get();

        FixedArrayMap<String, PreferenceScreenMetadataFactory> googlePreferenceScreenFactories =
                SettingsGoogleScreenCollector.get();

        return preferenceScreenFactories.merge(googlePreferenceScreenFactories);
    }
