 ...
 *           (C) 2011-2023 The XPerience Project
 *
...
public class StatusBarBatterySettings extends SettingsPreferenceFragment
    ...
    private static final String TAG = "XPerience Battery Styles";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBatteryTextCharging = (SystemSettingSwitchPreference) findPreference(STATUS_BAR_BATTERY_TEXT_CHARGING);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.statusbar_battery_settings);
}