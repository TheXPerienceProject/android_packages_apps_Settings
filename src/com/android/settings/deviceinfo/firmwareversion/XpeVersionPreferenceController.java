...
public class XpeVersionPreferenceController extends BasePreferenceController {

    private static final String TAG = "XPerienceVersionDialogCtrl2";
    ...
    public XpeVersionPreferenceController(Context context, String key) {
        super(context, key);
